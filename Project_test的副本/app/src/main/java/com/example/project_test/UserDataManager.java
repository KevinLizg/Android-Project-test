...
public class UserDataManager {             //用户数据管理类
    ...
    public static final String GESTURE= "user_gesture";
    public static final String USER_PWD = "user_pwd";
//    public static final String SILENT = "silent";
//    public static final String VIBRATE = "vibrate";
    private static final int DB_VERSION = 2;
    private Context mContext = null;
    private static final String P_TABLE="user_picture";
    ...
    private static final String P_CREATE = "CREATE TABLE " + P_TABLE + " ("
            + USER_NAME + " varchar, "
            + P_PATH + " varchar, "
            + " PRIMARY KEY("+USER_NAME+","+P_PATH+"), "
...
//            db.execSQL("DROP TABLE IF EXISTS " + W_CREATE + ";");
    ...
    public long insertUserData(UserData userData) {
        ...
        String userGes=userData.getGes();
        ContentValues values = new ContentValues();
        values.put(USER_NAME, userName);
        values.put(GESTURE,userGes);
...
//        Cursor mCursor=mSQLiteDatabase.query(TABLE_NAME, null, USER_NAME+"="+userName, null, null, null, null);
        ...
        while(cursor.moveToNext()){
            if(cursor.getString(cursor.getColumnIndex("user_name")).equals(userName)){
            result=1;
            cursor.close();
//            Log.i(TAG,"findUserByName , result="+result);
    ...
    public int findUserByNameAndGesture(String userName,String gesture){
        int result=0;
        Cursor mCursor=mSQLiteDatabase.query(TABLE_NAME, null, USER_NAME+"='"+userName+"'"+" and "+GESTURE+"='"+gesture+"'",
                null, null, null, null);
        if(mCursor!=null){
            result=mCursor.getCount();
            mCursor.close();
