...
public class Register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Gesture gestureLock = (Gesture) findViewById(R.id.set_gesture);
        gestureLock.setGestureListener(new Gesture.GestureListener() {
            @Override
...
//            final String[] ges = new String[1];
            ...
            if(userPwd.equals(userPwdCheck)==false){     //两次密码输入不一样
                ...
                UserData mUser = new UserData(userName, userPwd,ges);
...
//                    Toast.makeText(this, getString(R.string.register_success),Toast.LENGTH_SHORT).show();
                    Intent intent_Register_to_Login = new Intent(Register.this,Login.class) ;    //切换User Activity至Login Activity
//                    Intent intent_Register_to_Login = new Intent(Register.this,GestureLock.class);
                    startActivity(intent_Register_to_Login);
                    finish();
                }
            }
